...
const PRODUCT_HEADERS = [
  ...
  "Insignia","TextoDisponibilidad","Destacado","Personalizable","FabricadoPedido","BajoPedido",
...
function rowToProduct(row) {
  ...
  return {
    ...
    textoDisponibilidad: text(row.TextoDisponibilidad), destacado: bool(row.Destacado), personalizable: bool(row.Personalizable),
...
function productToRow(product) {
  ...
  return {
    ...
    Insignia: p.insignia || "", TextoDisponibilidad: p.textoDisponibilidad || "", Destacado: p.destacado ? "Sí" : "No", Personalizable: p.personalizable ? "Sí" : "No",
