...
router.post("/pages/:pageId/publish", controller.publishPage);
router.get("/pages/:pageId/history", controller.listHistory);
router.post("/pages/:pageId/history/:revisionId/restore", controller.restoreRevision);
